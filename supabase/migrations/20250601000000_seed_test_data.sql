...
('산리오❣️', 'sanrio', '헬로키티, 마이멜로디, 쿠로미 등 산리오 캐릭터 굿즈', 1, true),
('캐릭터🧡', 'character', '다양한 인기 캐릭터 굿즈', 2, true),
('핸드폰줄💛', 'phone-strap', '귀여운 핸드폰 스트랩 모음', 3, true),
('키링,지비츠💚', 'keyring', '키링과 크록스 지비츠 컬렉션', 4, true),
('패션잡화💙', 'fashion', '가방, 파우치, 악세서리', 5, true),
('곰돌이🤎', 'bear', '귀여운 곰돌이 캐릭터 상품', 6, true),
('완구문구💜', 'stationery', '문구용품과 장난감', 7, true)

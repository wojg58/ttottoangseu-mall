...
export default function AuthTestPage() {
  ...
  const testConnection = useCallback(async () => {
    try {
      ...
      if (err instanceof Error) {
        ...
        errorMessage = supabaseError.message || supabaseError.code || errorMessage;
      }
  ...
  const fetchOrCreateUser = useCallback(async () => {
    ...
    try {
      ...
      console.group("👤 사용자 데이터 조회/생성 시작");
      ...
      // PGRST116은 "not found" 에러 코드이므로 정상적인 경우
      ...
      if (err instanceof Error) {
        ...
        // Supabase 에러 객체: { code, message, details, hint }

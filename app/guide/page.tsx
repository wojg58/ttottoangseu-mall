          ...
          <div className="prose prose-lg max-w-none text-[#4a3f48] space-y-8">
            <section>
              ...
              <ol className="list-decimal list-inside space-y-3 text-lg leading-relaxed">
                ...
                <li>장바구니에서 주문할 상품을 확인하고 수량을 조정할 수 있습니다.</li>
              ...
              <div className="bg-[#ffeef5] rounded-lg p-6 space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>배송은 평일 기준으로 진행되며, 주말 및 공휴일은 배송이 지연될 수 있습니다.</li>
                    <li>도서산간 지역의 경우 추가 배송비가 발생할 수 있습니다.</li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>제주도 및 도서산간 지역: 추가 배송비 발생 (상품별 상이)</li>
                  </ul>
                </div>
                <div>
            ...
            <section>
              ...
              <div className="bg-[#ffeef5] rounded-lg p-6 space-y-3">
                ...
                <div>
                  ...
                  <p>가상계좌를 통한 무통장 입금이 가능합니다. 입금 확인 후 배송이 진행됩니다.</p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">간편결제</h3>
                  <p>카카오페이, 네이버페이 등 간편결제 서비스를 이용하실 수 있습니다.</p>
                </div>
              </div>
            </section>
              ...
              <div className="bg-[#ffeef5] rounded-lg p-6 space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>단, 상품의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 경우에는 상품을 수령한 날부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 교환/환불 신청 가능</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">교환/환불 불가 사유</h3>
                  <ul className="list-disc list-inside space-y-1">
                    <li>고객의 단순 변심으로 인한 경우 (단, 상품의 내용이 표시·광고 내용과 다른 경우는 제외)</li>
                    <li>상품 및 포장을 훼손하여 상품의 가치가 현저히 감소한 경우</li>
            ...
            <section>
              ...
              <div className="bg-[#ffeef5] rounded-lg p-6 space-y-3">
                ...
                <div>
                  ...
                  <p>일정 금액 이상 구매 시 무료배송 혜택을 받으실 수 있습니다.</p>
                </div>
              </div>
            </section>

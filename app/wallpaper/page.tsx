        ...
        <div className="grid md:grid-cols-5 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 md:col-span-3">
            ...
            <a
              ...
              download
              className="inline-flex items-center justify-center gap-2 w-full px-4 py-3 bg-[#ff6b9d] text-white rounded-lg font-bold hover:bg-[#ff5088] transition-colors mb-[1cm]"
            >
              <Download className="w-5 h-5" />
              PC 다운로드
            </a>

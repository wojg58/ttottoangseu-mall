/**
 * @file app/admin/settings/activity-logs/page.tsx
 * @description 관리자 활동 로그 페이지
 *
 * 주요 기능:
 * 1. 관리자 활동 로그 목록 조회 (admin_activity_logs 테이블)
 * 2. 변경 전/후 값 비교
 * 3. 필터링 및 검색 (action, entity_type, admin_email, 기간)
 * 4. 페이지네이션
 */
...
import AdminActivityLogsList from "@/components/admin/admin-activity-logs-list";
...
export default async function ActivityLogsPage({
  ...
  if (error) {
    console.error("[ActivityLogsPage] 관리자 활동 로그 조회 실패:", error);
  }

/**
 * @file components/admin/audit-logs-list.tsx
...
export default function AuditLogsList({
  ...
  const handleReset = () => {
    ...
    setEntityTypeFilter("");
    setAdminEmailFilter("");
    router.push("/admin/settings/audit-logs?page=1");
  };
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      {log.ip && (
                        <div className="text-xs text-[#8b7d84] mt-1">
                          IP: {log.ip}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="bg-red-50 border border-red-200 rounded p-3">
                          ...
                          <div className="text-sm text-red-900 font-mono break-all whitespace-pre-wrap">
                        ...
                        <div className="bg-green-50 border border-green-200 rounded p-3">
                          ...
                          <div className="text-sm text-green-900 font-mono break-all whitespace-pre-wrap">
